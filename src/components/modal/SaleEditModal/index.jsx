...
export const SaleEditModal = () => {
    ...
    const { closeModal, currentSale,
        selectEtapas, selectedEtapas, setSelectedEtapas,
    ...
    const onSubmit = (data) => {
        ...
        const compareAndLogChange = (fieldName, formDataValue, currentSaleValue, pertence) => {
            ...
            if (currentSaleValue === null || currentSaleValue === undefined || currentSaleValue === 0) {
                currentSaleValue = ""
        ...
        compareAndLogChange("cpf", data.cpf, retiraCaracteres(currentSale.cpf), "cliente")
        compareAndLogChange("cnpj", data.cnpj, retiraCaracteres(currentSale.cnpj), "cliente")
        compareAndLogChange("dt_nascimento", data.data_nascimento, formatarData(currentSale.dt_nascimento), "cliente")
        compareAndLogChange("nome_mae", data.nome_mae, currentSale.nome_mae, "cliente")
        compareAndLogChange("email", data.email, currentSale.email, "cliente")
        compareAndLogChange("telefone_1", data.telefone_1, currentSale.telefone_1, "cliente")
        compareAndLogChange("telefone_2", data.telefone_2, currentSale.telefone_2, "cliente")
        ...
        // Venda
        compareAndLogChange("dt_instalacao", data.data_instalacao, formatarData(currentSale.dt_instalacao), "venda")
        compareAndLogChange("user_ger", selectedUsuario, currentSale.id_usuario, "venda")
        compareAndLogChange("dt_ger", data.data_venda, formatarData(currentSale.dt_ger), "venda")
        compareAndLogChange("plano", selectedProdutos, currentSale.id_produto, "venda")
        compareAndLogChange("tipo_pagmento", selectedFormPag, currentSale.id_formpag, "venda")
